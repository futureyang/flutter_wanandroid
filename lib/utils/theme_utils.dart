...
class ThemeUtils {
  ...
  static Color getIconColor(BuildContext context) {
    return isDark(context) ? MyColor.dark_text : null;
  }
  
  static Color getStickyHeaderColor(BuildContext context) {
    return isDark(context) ? MyColor.dark_bg_gray_ : MyColor.bg_gray_;
  }

  static Color getDialogTextFieldColor(BuildContext context) {
    return isDark(context) ? MyColor.dark_bg_gray_ : MyColor.bg_gray;
  }

  static Color getKeyboardActionsColor(BuildContext context) {
    return isDark(context) ? MyColor.dark_bg_color : Colors.grey[200];
  }
  ...
  static void setSystemBarStyle({bool isDark}) {
    if (Device.isAndroid) {
      ...
      final SystemUiOverlayStyle systemUiOverlayStyle = SystemUiOverlayStyle(
        ...
        systemNavigationBarColor: _isDark ? MyColor.dark_bg_color : Colors.white,
...
extension ThemeExtension on BuildContext {
  ...
  Color get bgColorSecondary => Theme.of(this).scaffoldBackgroundColor;
