...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
			case PointRankList:
				return pointRankListFromJson(data as PointRankList, json) as T;
			case PointRank:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			case PointRankList:
				return pointRankListToJson(data as PointRankList);
			case PointRank:
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		if(type == (PointRankList).toString()){
			return PointRankList().fromJson(json);
		}	else if(type == (PointRank).toString()){
  ...
  //list is returned by type
	static M _getListChildType<M>(List data) {
		if(<PointRankList>[] is M){
			return data.map<PointRankList>((e) => PointRankList().fromJson(e)).toList() as M;
		}	else if(<PointRank>[] is M){
